...
@AllArgsConstructor
public class LootboxesButton extends Button {

    private static final int PRICE = 35;

    @Override
    public String getName(Player player) {
        return ChatColor.LIGHT_PURPLE.toString() + "3x Pandora Boxes";
    }
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "monthlycrate give " + player.getName() + " Pandora 3");
