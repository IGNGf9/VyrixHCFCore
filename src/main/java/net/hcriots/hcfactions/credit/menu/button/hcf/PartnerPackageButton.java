...
@AllArgsConstructor
public class PartnerPackageButton extends Button {

    private static final int PRICE = 25;

    @Override
    public String getName(Player player) {
        return ChatColor.LIGHT_PURPLE.toString() + "3x Partner Packages";
    }
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "partnerpackage " + player.getName() + " 3");
