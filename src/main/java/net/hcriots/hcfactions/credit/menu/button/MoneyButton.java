...
public class MoneyButton extends Button {
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Hulu.getInstance().getEconomyHandler().setBalance(player.getUniqueId(), Hulu.getInstance().getEconomyHandler().getBalance(player.getUniqueId()) + 1000);
