...
@AllArgsConstructor
public class AirdropsButton extends Button {

    private static final int PRICE = 30;

    @Override
    public String getName(Player player) {
        return ChatColor.GOLD.toString() + "3x Airdrops";
    }
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "airdrops give " + player.getName() + " 3");
