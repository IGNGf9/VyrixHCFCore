...
@AllArgsConstructor
public class GodButton extends Button {

    private static final int PRICE = 35;

    @Override
    public String getName(Player player) {
        return ChatColor.DARK_PURPLE.toString() + ChatColor.BOLD + "God Key";
    }
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "cr givekey " + player.getName() + " God 1");
