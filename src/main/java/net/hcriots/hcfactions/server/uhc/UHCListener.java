...
package net.hcriots.hcfactions.server.uhc;
...
public class UHCListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        Bukkit.getScheduler().runTaskLater(Hulu.getInstance(), () -> init(event.getPlayer()), 1L);
    }
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        Bukkit.getScheduler().runTaskLater(Hulu.getInstance(), () -> deathTime.remove(event.getEntity().getUniqueId()), 20L);
    }
