...
public class GoliathButton extends Button {

    private static final int PRICE = 50;

    @Override
    public String getName(Player player) {
        return ChatColor.GOLD + "Goliath Egg";
    }
    ...
    public List<String> getDescription(Player player) {
        ...
        lore.add("");
        lore.add(ChatColor.GRAY + "Reward: " + ChatColor.WHITE + "10 Faction Points");
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "bossegg Goliath 1 " + player.getName());
            player.sendMessage(ChatColor.GOLD + "You have purchased 1 Goliath Egg");
