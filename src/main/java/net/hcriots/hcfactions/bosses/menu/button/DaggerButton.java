...
public class DaggerButton extends Button {

    private static final int PRICE = 25;

    @Override
    public String getName(Player player) {
        return ChatColor.AQUA + "Dagger Egg";
    }
    ...
    public List<String> getDescription(Player player) {
        ...
        lore.add("");
        lore.add(ChatColor.GRAY + "Reward: " + ChatColor.WHITE + "5 Faction Points");
    ...
    public void clicked(Player player, int i, ClickType clickType) {
        if (clickType.isRightClick() || clickType.isLeftClick()) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "bossegg Dagger 1 " + player.getName());
            player.sendMessage(ChatColor.GOLD + "You have purchased 1 Dagger Egg");
