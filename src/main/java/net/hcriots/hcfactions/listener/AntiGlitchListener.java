...
import net.hcriots.hcfactions.util.MaterialUtils;
import org.bukkit.*;
...
public class AntiGlitchListener implements Listener {
    ...
    public void onBoatMove(VehicleMoveEvent event) {
        ...
        if (block.getType() == Material.FENCE_GATE) {
            ...
            if (passenger != null && passenger instanceof Player) {
                boolean value = Hulu.getInstance().getLanguageMap().isNewLanguageToggle(passenger.getUniqueId());
                ((Player) passenger).sendMessage((value ? ChatColor.RED + "You can't move your boat into a fence gate." : ChatColor.RED + "No puedes mover tu barco hasta la puerta de una valla."));
            }
        }
    }
    ...
    public void onPlayerBoatMove(PlayerMoveEvent event) {
        ...
        if (player.getVehicle() != null && player.getVehicle() instanceof Boat) {
            if (to.getBlock().getType() == Material.FENCE_GATE) {
                ...
                player.sendMessage((value ? ChatColor.RED + "You can't move your boat into a fence gate." : ChatColor.RED + "No puedes mover tu barco hasta la puerta de una valla."));
            }
        }
    }
    ...
    public void denyDismountClipping(VehicleExitEvent event) {
        ...
        Bukkit.getScheduler().runTask(Hulu.getInstance(), () -> player.teleport(finalLocation));
    }
