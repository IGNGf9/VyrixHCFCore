...
public class StatTrakListener implements Listener {
    ...
    private static final String minerLine = ChatColor.RED + "------" + ChatColor.YELLOW + " Pickaxe Stats " + ChatColor.RED + "------";
    private static final String axeLine = ChatColor.RED + "------" + ChatColor.YELLOW + " Axe Stats " + ChatColor.RED + "------";
    private static final String spadeLine = ChatColor.RED + "------" + ChatColor.YELLOW + " Shovel Stats " + ChatColor.RED + "------";
            ...
            if (held.getType().name().toLowerCase().contains("pickaxe") && type.name().toLowerCase().contains("ore")) {
                ...
                for (int i = 0; i < lore.size(); i++) {
                    ...
                    if (line.substring(2).startsWith(formatOre(type))) {
                        int count = Integer.valueOf(line.substring(formatOre(type).length() + 6));
